...
const FitoutSettingsPage = lazy(() => import('@/pages/fitout/FitoutSettingsPage'));
const FitoutDailyReportPage = lazy(() => import('@/pages/fitout/FitoutDailyReportPage'));
const FitoutGanttPage = lazy(() => import('@/pages/fitout/FitoutGanttPage'));
const FitoutDashboardPage = lazy(() => import('@/pages/fitout/FitoutDashboardPage'));
...
const CrossMallDashboard = lazy(() => import('@/pages/cross-mall/CrossMallDashboard'));
...
const SalesPipelineStatsPage = lazy(() => import('@/pages/pipeline-stats/SalesPipelineStatsPage'));
