...
/**
 * Exported so components that must render NumericFormat directly — because they
 * need react-hook-form `useController` wiring that `Input`'s register-style
 * bridge cannot provide — still match the design system exactly.
 * See `components/form/NumericField.tsx`.
 */
export const INPUT_BASE_CLASS = BASE_CLASS;
