              ...
              {invoices.map((inv) => {
                ...
                return (
                  <tr key={inv.id}
                    ...
                    <td className="px-3 py-2 text-xs text-muted-foreground"><div>{inv.serviceContractPayment?.milestone || inv.period}</div><div className="text-[11px] text-muted-foreground/70">{inv.type}</div></td>
